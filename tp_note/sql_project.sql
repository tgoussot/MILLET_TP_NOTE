...
CREATE TABLE emprunt (
  ...
  FOREIGN KEY(adherent_id) REFERENCES adherent(id_adherent) ON DELETE CASCADE,
  FOREIGN KEY(exemplaire_id) REFERENCES exemplaire(id_exemplaire) ON DELETE CASCADE
);
